...
import InDepthPage from "../redesign/InDepthRedesign";
import CareerRedesignPlus from "./CareerRedesignPlus";
...
const baseImage = "https://hikewise.sgp1.digitaloceanspaces.com/hikewise/images/report/redesign";
const bestFitImage = "https://hikewise.sgp1.digitaloceanspaces.com/hikewise/images/report/rise/post-cc.svg";

/* ----------------------------------------------------------------------------------------- */

export default function ReportRedesignPlus({ report }) {
  const data = report;
      ...
      <div className={style.wrapper}>
        <Page className={clsx(style.page1, style.staticImg)}>
          <img
            ...
            src={`${"https://hikewise.sgp1.digitaloceanspaces.com/hikewise/images/report/redesign_plus"}/01.svg`}
            alt=""
          />
          <div className={style.nameContainer}>
            ...
            <div className={style.text}>{moment(new Date(report.date_of_generation)).format("MMMM D, YYYY")}</div>
          </div>
        </Page>
        ...
        <Page className={clsx(style.page5, style.profileSummary)}>
          ...
          <div className={style.text}>
            This section of the report will present a summary of your psychometric profile by highlighting your dominant
            interest areas, personality aspects, aptitudes, work value preferences and emotional quotient.
          </div>
        ...
        <Page>
          <InDepthPage
            ...
            AnalysisComponent={() => <AnalysisNumApti score={data.character_data.aptitude.numerical_aptitude} />}
            ImprovComponent={() => <ImprovNumApti score={data.character_data.aptitude.numerical_aptitude} />}
          />
        </Page>
        ...
        <Page>
          <InDepthPage
            ...
            AnalysisComponent={() => <AnalysisVerbalApti score={data.character_data.aptitude.verbal_aptitude} />}
            ImprovComponent={() => <ImprovVerbalApti score={data.character_data.aptitude.verbal_aptitude} />}
          />
        </Page>
        ...
        <Page>
          <InDepthPage
            ...
            AnalysisComponent={() => <AnalysisMechReason score={data.character_data.aptitude.mechanical_reasoning} />}
            ImprovComponent={() => <ImprovMechReason score={data.character_data.aptitude.mechanical_reasoning} />}
          />
        </Page>
        ...
        <Page>
          <InDepthPage
            ...
            AnalysisComponent={() => <AnalysisAbsReason score={data.character_data.aptitude.abstract_reasoning} />}
            ImprovComponent={() => <ImprovAbsReason score={data.character_data.aptitude.abstract_reasoning} />}
          />
        </Page>
        ...
        <Page>
          <InDepthPage
            ...
            AnalysisComponent={() => <AnalysisSpaApti score={data.character_data.aptitude.spatial_aptitude} />}
            ImprovComponent={() => <ImprovSpaApti score={data.character_data.aptitude.spatial_aptitude} />}
          />
        </Page>
        ...
        <Page>
          <InDepthPage
            ...
            AnalysisComponent={() => <AnalysisPerApti score={data.character_data.aptitude.perceptual_aptitude} />}
            ImprovComponent={() => <ImprovPerApti score={data.character_data.aptitude.perceptual_aptitude} />}
          />
        </Page>
        ...
        <Page>
          <InDepthPage
            ...
            AnalysisComponent={() => <AnalysisSelfControl score={data.character_data.personality.self_control} />}
            ImprovComponent={() => <ImprovSelfControl score={data.character_data.personality.self_control} />}
          />
        </Page>
        ...
        <Page>
          <InDepthPage
            ...
            AnalysisComponent={() => <AnalysisStressTol score={data.character_data.personality.stress_tolerance} />}
            ImprovComponent={() => <ImprovStressTol score={data.character_data.personality.stress_tolerance} />}
          />
        </Page>
        ...
        <Page>
          <InDepthPage
            ...
            AnalysisComponent={() => <AnalysisCompassion score={data.character_data.personality.compassion} />}
            ImprovComponent={() => <ImprovCompassion score={data.character_data.personality.compassion} />}
          />
        </Page>
        ...
        <Page>
          <InDepthPage
            ...
            AnalysisComponent={() => <AnalysisPoliteness score={data.character_data.personality.politeness} />}
            ImprovComponent={() => <ImprovPoliteness score={data.character_data.personality.politeness} />}
          />
        </Page>
        ...
        {data.character_data.personality.industriousness && (
          <Page>
            <InDepthPage
              ...
              AnalysisComponent={() => (
                <AnalysisIndustriousness score={data.character_data.personality.industriousness} />
              )}
              ImprovComponent={() => <ImprovIndustriousness score={data.character_data.personality.industriousness} />}
            />
          </Page>
        )}
        ...
        <Page>
          <InDepthPage
            ...
            AnalysisComponent={() => <AnalysisOrderliness score={data.character_data.personality.orderliness} />}
            ImprovComponent={() => <ImprovOrderliness score={data.character_data.personality.orderliness} />}
          />
        </Page>
        ...
        <Page>
          <InDepthPage
            ...
            AnalysisComponent={() => <AnalysisEnthu score={data.character_data.personality.enthusiasm} />}
            ImprovComponent={() => <ImprovEnthu score={data.character_data.personality.enthusiasm} />}
          />
        </Page>
        ...
        <Page>
          <InDepthPage
            ...
            AnalysisComponent={() => <AnalysisAssertiveness score={data.character_data.personality.assertiveness} />}
            ImprovComponent={() => <ImprovAssertiveness score={data.character_data.personality.assertiveness} />}
          />
        </Page>
        ...
        <Page>
          <InDepthPage
            ...
            AnalysisComponent={() => <AnalysisIntellect score={data.character_data.personality.intellect} />}
            ImprovComponent={() => <ImprovIntellect score={data.character_data.personality.intellect} />}
          />
        </Page>
        ...
        <Page>
          <InDepthPage
            ...
            AnalysisComponent={() => <AnalysisOpenness score={data.character_data.personality.openness} />}
            ImprovComponent={() => <ImprovOpenness score={data.character_data.personality.openness} />}
          />
        </Page>
        ...
        <Page className={clsx(style.page9, style.details)}>
          ...
          <div className={style.boxContainer}>
            <Box data={report.dominant_wvp.slice(0, 3)} options={{ background: _Colors.wvp, size: "medium" }} />
          </div>
          <div className={style.graphContainer}>
            <Graph
              data={{
        ...
        <Page>
          <InDepthPage
            ...
            ImprovComponent={() => <ImprovAchievement score={data.character_data.wvp.achievement} />}
          />
        </Page>
        ...
        <Page>
          <InDepthPage
            ...
            ImprovComponent={() => <ImprovIndep score={data.character_data.wvp.independence} />}
          />
        </Page>
        ...
        <Page>
          <InDepthPage
            ...
            ImprovComponent={() => <ImprovRecog score={data.character_data.wvp.recognition} />}
          />
        </Page>
        ...
        {data.character_data.wvp.relationships && (
          <Page>
            <InDepthPage
              ...
              ImprovComponent={() => <ImprovRelation score={data.character_data.wvp.relationships} />}
            />
          </Page>
        )}
        ...
        <Page>
          <InDepthPage
            ...
            ImprovComponent={() => <ImprovSupport score={data.character_data.wvp.support} />}
          />
        </Page>
        ...
        {data.character_data.wvp.working_conditions && (
          <Page>
            <InDepthPage
              ...
              ImprovComponent={() => <ImprovWorkCond score={data.character_data.wvp.working_conditions} />}
            />
          </Page>
        )}
        ...
        <Page className={clsx(style.page9, style.details)}>
          ...
          <div className={style.boxContainer}>
            <Box data={report.dominant_eq.slice(0, 1)} options={{ background: _Colors.eq, size: "medium" }} />
          </div>
          <div className={style.graphContainer}>
            <Graph
              data={{
        ...
        <Page>
          <InDepthPage
            ...
            AnalysisComponent={() => <AnalysisEmoComp score={data.character_data.eq.emotional_competency} />}
            ImprovComponent={() => <ImprovEmoComp score={data.character_data.eq.emotional_competency} />}
          />
        </Page>
        ...
        <Page>
          <InDepthPage
            ...
            AnalysisComponent={() => <AnalysisEmoMaturity score={data.character_data.eq.emotional_maturity} />}
            ImprovComponent={() => <ImprovEmoMaturity score={data.character_data.eq.emotional_maturity} />}
          />
        </Page>
        ...
        <Page>
          <InDepthPage
            ...
            AnalysisComponent={() => <AnalysisEmoSensi score={data.character_data.eq.emotional_sensitivity} />}
            ImprovComponent={() => <ImprovEmoSensi score={data.character_data.eq.emotional_sensitivity} />}
          />
        </Page>
        ...
        {[...report.dominant_careers].splice(0, 5).map((career) => (
          <>
            <Page>
              <CareerRedesignPlus data={career[3]} name={career[0]} img={career[1]} />
            </Page>
          </>
        ))}
        ...
        <Page className={clsx(style.page2, style.staticImg)}>
          ...
          <div className={clsx(style.absoluteContent, style.bestFitCareers)}>
            ...
            <div className={style.careers}>
              {[...report.dominant_careers].slice(5, 10).map((career) => (
